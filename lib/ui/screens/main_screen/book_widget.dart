...
import 'package:yulib_manager/ui/screens/main_screen/book_detail_screen.dart';
...
class BookWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
        color: bookModel.active ? Colors.green : Colors.red,
        child: InkWell(
          onTap: () {
                ...
                Expanded(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                          "Status: ${bookModel.active ? "Not Ordered" : "Ordered"}"),
                    ],
                  ),
                ),
              ],
